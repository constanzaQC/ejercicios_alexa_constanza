...
document.addEventListener("DOMContentLoaded", () => {
    let usuariosi = false;
    let votos = {}; // Almacena los votos por candidato
    let candidatos = []; // Lista de candidatos
    ...
    function cargarCandidatos() {
        ...
        elecSection.innerHTML = ""; // Limpia cualquier contenido previo
